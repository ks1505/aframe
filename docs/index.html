...
<script src="https://rawcdn.githack.com/ks1505/aframe/24d652a9e4fb0c3cb0448fb9f6f6696276da970d/dist/aframe-v0.8.2.min.js"></script>
...
<body>
  ...
  <a-scene  gesture-detector embedded arjs renderer="precision: mediump">
  ...
  <!--<script>
    ...
    <a-assets>
        <a-asset-item id="sofa" src="https://midair.in/wp-content/uploads/sofa.glb"></a-asset-item>
